...
def register_runtime_handlers(dp):
    dp.include_router(router)

@router.message(F.text == "⚡ Runtime")
async def runtime_handler(message: Message, dispatcher: Dispatcher):
    ...
    text = TelegramFormatter(analyzed).runtime_info()
