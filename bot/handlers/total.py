...
def register_total_handlers(dp):
    dp.include_router(router)

@router.message(F.text == "📊 Total")
async def total_handler(message: Message, dispatcher: Dispatcher):
    ...
    text = TelegramFormatter(analyzed).total_info()
